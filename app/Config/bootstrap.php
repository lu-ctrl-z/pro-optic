 ...
 */
/**
 * config for admin controller not check login
 */
Configure::write(
    'admin_controller',
        array(
...
/**
 * config for admin action check login
 */
Configure::write(
    'action_admin_login_not_check',
           array(
               'login',
               'logout',
               'auth'
 ...
 */
Configure::write(
    'action_admin_login_not_redirect',
           array(
               'login',
               'auth'
           )
 ...
 */
Configure::write('batch_file_path', ROOT . '/app/Console/cake');
