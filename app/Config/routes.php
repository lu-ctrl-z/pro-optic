 ...
 */
    ...
    Router::connect('/portal/ulist', array('controller' => 'adminUser', 'action' => 'index'));
    Router::connect('/portal/uadd', array('controller' => 'adminUser', 'action' => 'add'));
    Router::connect('/portal/uadd/preview', array('controller' => 'adminUser', 'action' => 'addConfirm'));
    ...
    Router::connect('/entry/complete', array('controller' => 'newentry', 'action' => 'entryComplete'));
    //End Newentry
    //Start Singup
